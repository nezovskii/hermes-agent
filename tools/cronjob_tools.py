    ...
    try:
        ...
        if normalized == "update":
            ...
            if feedback is not None:
                updates["feedback"] = bool(feedback)
...
Important safety rule: cron-run sessions should not recursively schedule more cron jobs.""",
    "parameters": {
        ...
        "properties": {
            ...
            "feedback": {
                "type": "boolean",
                "description": "Attach non-blocking rating actions to supported platform deliveries. Telegram shows Interesting / Not interesting, then a multi-select reason keyboard. Feedback is stored locally under the profile cron directory."
            },
        },
        "required": ["action"]
    }
